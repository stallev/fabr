				...
				<div class="preim">
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
								<div class="preim-item">
									<div class="preim-img preim-img--2"></div>
									<p class="preim-ttl">Изготовление окна <br>за 3 дня</p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
								<div class="preim-item">
									<div class="preim-img preim-img--3"></div>
									<p class="preim-ttl">Москитная сетка <br>в подарок</p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
								<div class="preim-item">
									<div class="preim-img preim-img--4"></div>
			...
			<div class="bg bg2">
				<div class="container">
					<div class="row">
						<div class="menu-wrap">
							<ul class="menu">
								<li class="menu__item menu__item--1" ><p>Витражи</p></li>
								<li class="menu__item menu__item--2"><p>Остекление квартир</p></li>
								<li class="menu__item menu__item--3"><p>Остекление балконов</p></li>
								<li class="menu__item menu__item--4"><p>Остекление коттеджей</p></li>
								...
								<div class="container-fluid no-padding-right">
									<div class="row">
										<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
											<div class="uslugi-item uslugi-item--1 tall-item">
										...
										<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
											<div class="row">
												<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
													<div class="uslugi-item uslugi-item--2">
												...
												<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
													<div class="uslugi-item uslugi-item--3">
												...
												<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
													<div class="uslugi-item uslugi-item--4">
												...
												<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
													<div class="uslugi-item uslugi-item--5">
					...
					<div class="zayavka">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 pull-right">
								<p class="zayavka-ttl"><span style="color:#00c0ff;">Оставьте заявку</span> и мы <br><span class="zayavka-ttl__text">рассчитаем стоимость</span> <br>Ваших окон</p>
				...
				<div class="container">
					<div class="stoimost">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<p class="stoimost-item stoimost-item--1">Площадь производства 2500 м<sup>2</sup></p>
								<p class="stoimost-item stoimost-item--2">2 полуавтоматические линии по изготовлению окон</p>
								<p class="stoimost-item stoimost-item--3">400 м<sup>2</sup> профиля в день</p>
							</div>
						</div>
					</div>
					<div class="stoimost-gallery">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="stoimost-img stoimost-img--1">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="stoimost-img stoimost-img--2">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="stoimost-img stoimost-img--3">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="stoimost-img stoimost-img--4">
										</div>
									</div>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="stoimost-img stoimost-img-tall stoimost-img--5">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="garant-item">
									<div class="garant-img garant-img--1"></div>
									<p class="garant-item-ttl">Срок изготовления <br>3-5 дней</p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="garant-item">
									<div class="garant-img garant-img--2"></div>
									<p class="garant-item-ttl">Монтаж 1 день</p>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="garant-item">
									<div class="garant-img garant-img--3"></div>
							...
							<div class="jobs-slider-wrap">
								<div class="jobs-slider owl-carousel">
									<div class="item">
										<div class="row">
											<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
												<div class="jobs-img jobs-img-tall jobs-img--44">
													<div class="jobs-big-img jobs-big-img--44"></div>
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
												<div class="row">
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--55">
															<div class="jobs-big-img jobs-big-img--55"></div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--66">
															<div class="jobs-big-img jobs-big-img--66"></div>
															<div class="jobs-name">Бизнес центр на ул. Вострецова</div>
															<div class="jobs-text">
																Произведено комплексное остекление панорамных витражей из теплого (стоечно-ригельного) алюминиевого профиля коричневого цвета. Заполнение  - двухкамерный стеклопакет, тонированный. Так же изготовлены и смонтированы входные группы и двери. Площадь остекления – 130 кв.м. 
															</div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--77">
															<div class="jobs-big-img jobs-big-img--77"></div>
															<div class="jobs-name">Бизнес центр на ул. Вострецова</div>
															<div class="jobs-text">
																Произведено комплексное остекление панорамных витражей из теплого (стоечно-ригельного) алюминиевого профиля коричневого цвета. Заполнение  - двухкамерный стеклопакет, тонированный. Так же изготовлены и смонтированы входные группы и двери. Площадь остекления – 130 кв.м. 
															</div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--5">
															<div class="jobs-big-img jobs-big-img--5"></div>
									...
									<div class="item">
										<div class="row">
											<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
												<div class="jobs-img jobs-img-tall jobs-img--1">
													<div class="jobs-big-img jobs-big-img--1" ></div>
											...
											<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
												<div class="row">
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--2">
															<div class="jobs-big-img jobs-big-img--2"></div>
															<div class="jobs-name">ЖК Комсомольский</div>
															<div class="jobs-text">
																Произведено комплексное остекление жилого комплекса. Окна из ПВХ профиля монтажной глубиной 70 мм., с двухкамерным стеклопакетом. Витражи лоджий выполнены в холодном варианте с возможностью утепления без особых затрат. Площадь остекления 8000 м2
															</div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--3">
															<div class="jobs-big-img jobs-big-img--3"></div>
															<div class="jobs-name">ЖК Комсомольский</div>
															<div class="jobs-text">
																Произведено комплексное остекление жилого комплекса. Окна из ПВХ профиля монтажной глубиной 70 мм., с двухкамерным стеклопакетом. Витражи лоджий выполнены в холодном варианте с возможностью утепления без особых затрат. Площадь остекления 8000 м2
															</div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--4">
															<div class="jobs-big-img jobs-big-img--4"></div>
															<div class="jobs-name">ЖК Комсомольский</div>
															<div class="jobs-text">
																Произведено комплексное остекление жилого комплекса. Окна из ПВХ профиля монтажной глубиной 70 мм., с двухкамерным стеклопакетом. Витражи лоджий выполнены в холодном варианте с возможностью утепления без особых затрат. Площадь остекления 8000 м2
															</div>
													...
													<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
														<div class="jobs-img jobs-img--99">
															<div class="jobs-big-img jobs-big-img--99"></div>
															<div class="jobs-name">ЖК Комсомольский</div>
															<div class="jobs-text">
																Произведено комплексное остекление жилого комплекса. Окна из ПВХ профиля монтажной глубиной 70 мм., с двухкамерным стеклопакетом. Витражи лоджий выполнены в холодном варианте с возможностью утепления без особых затрат. Площадь остекления 8000 м2
															</div>
			...
			<div class="bg bg4">
				<div class="container">
					<div class="svoe">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="svoe-item">
									<div class="svoe-item-img svoe-item-img--1"></div>
								...
								<div class="svoe-item">
									<div class="svoe-item-img svoe-item-img--2"></div>
									<div class="svoe-item-text">
								...
								<div class="svoe-item">
									<div class="svoe-item-img svoe-item-img--3"></div>
									<div class="svoe-item-text">
					...
					<div class="cycle">
						<div class="row">
							...
							<div class="cycle-item">
								<div class="cycle-img cycle-img--1"></div>
							...
							<div class="cycle-item">
								<div class="cycle-img cycle-img--2"></div>
							...
							<div class="cycle-item">
								<div class="cycle-img cycle-img--3"></div>
					...
					<div class="zayavka-open">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 pull-right">
								<p class="zayavka-open-ttl"><span><span class="zayavka-open-ttl__text">Оставьте заявку</span> сейчас</span> <br>и получите 1 год обслуживания Бесплатно</p>
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<p class="zayavka-open-txt zayavka-open-txt--musor">Бесплатный вынос мусора после установки</p>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<p class="zayavka-open-txt zayavka-open-txt--zamer">Бесплатный выезд специалиста на замер</p>
									</div>
								</div>
								<form action="POST" name="zayavka-open-form" class="zayavka-open-form">
									<div class="row">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-7 col-lg-6 pull-left">
								...
								<p class="contacts-address">
									...
									<a href="tel:83472668905" class="contacts-tel">8 <span class="contacts-address__phone-code">(347)</span> 266-89-05</a>
								</p>
								<p class="contacts-address">
